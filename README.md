...
# Contributions 🌸🍒
🍓🍓 For contributing or viewing the code please clone from `dev1` branch 🍓🍓

# Contributors 🌼🎍
1. 🙈 [Moinak Banerjee](https://github.com/moinak878)
2. 🙉 [Rishita Shaw](https://github.com/theseregrets)
3. 🙊 [Shaily Shekhar](https://github.com/shelobel)  

# Pre-requisites 🍧

In order to develop and build "SolVows," the following pre-requisites must be installed:
